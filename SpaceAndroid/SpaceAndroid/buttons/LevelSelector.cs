...
namespace SpaceAndroid {
    public class LevelSelector : ButtonController{
        scene Level;
        private MouseState oldState;
        float _timer = 0;
        float tim = 0.15f;

        public LevelSelector(Texture2D t, Rectangle s, SpriteFont f, Color c, scene Slevel) : base(t, s, f, c) {
            Level = Slevel;
        }
